...
export class GameApp{
    #videojuegos;
    #videojuegosInstanciados;
    #user;
    #scores;
    #eventoLogin;
    #eventoRegister;
    #eventoLogout;
    #eventoEliminarUsuario;
    constructor(){
        this.#videojuegos = [
    ...
    async #mostrarJuegosEnPantalla(){
        ...
        if(this.#user.conectado === false){
            juegosHTML += `
               <p class="p__misJuegos">Para llevar un seguimiento de tus juegos, regístrate o inicia sesión. </p>
            `
